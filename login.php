...
$client->setClientId('289065057867-0skcf1s47vauiav10uh0j9ar8c3bg5l6.apps.googleusercontent.com');
// Enter your Client Secrect
$client->setClientSecret('hYnhZ2Ao_vk3ozEKkiZ9yXSe');
// Enter the Redirect URL
$client->setRedirectUri('http://localhost/axocheck_test/login.php');
